...
open class ApiClient(val baseUrl: String) {
    companion object {
        ...
        protected const val JsonMediaType = "application/hal+json"
    ...
    protected inline fun <reified T> requestBody(content: T, mediaType: String = JsonMediaType): RequestBody =
        when {
            ...
            mediaType == JsonMediaType -> Serializer.marshaller.writeValueAsString(content).toRequestBody(
                mediaType.toMediaTypeOrNull()
            )
    ...
    protected inline fun <reified T: Any?> responseBody(body: ResponseBody?, mediaType: String? = JsonMediaType): T? {
        ...
        return when(mediaType) {
            JsonMediaType -> Serializer.marshaller.readValue(bodyContent, T::class.java)
